        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Datos de Ventas 
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            $ventas = consultas::get_datos
                                            ("select * from v_ventas where id_venta=" . $_REQUEST ['vcod'] . "order by id_venta asc");
//                            if (!empty($ventas)) {
                            ?>                         
                            <!-- /.panel-heading -->
                                        ...
                                        <tbody>
                                            <?php foreach ($ventas as $venta) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php echo number_format($venta['ven_total'], 0, ',', '.'); ?></td>
                                                    <td class="text-center">
                        ...
                        $detventas = consultas::get_datos
                                        ("select * from v_detventas where id_venta=" . $_REQUEST['vcod'] . "order by id_articulo asc");
                        ?>
                ...
                <div class="col-md-12">
                    <div class="panel-body">
                        <form action="detventas_control.php" method="get"
                            ...
                            <input type="hidden" name="pagina" value="detventas_agregar.php">
            ...
            <script>
                function borrar (datos) {
                    ...
                    $('#si').attr('href',
                    'detventas_control.php?vcod=' + dat[1] +
                            '&vdep=' + dat[2] +
                            '&varti=' + dat[0] +
                            '&vprecio=null' +
                            '&vcant=' + dat[3] +
