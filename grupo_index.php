        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Listado de Grupos 
                                        ...
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($grupo as $grupos) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $grupos['gru_cod']; ?></td>
                                                        <td class="text-center"><?php echo $grupos['gru_nombre']; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $grupos['gru_cod'] . "_" .
                                            $grupos['gru_nombre'] . "'";
                                                    ?>)" 
                                                               class="btn btn-xs btn-primary" rel='tooltip' data-title="Editar" 
                                                               data-toggle="modal" data-target="#editar">
                                                                <span class="glyphicon glyphicon-pencil"></span></a>
                                                            <a onclick="borrar(<?php echo "'" . $grupos['gru_cod'] . "_" .
                                                       $grupos['gru_nombre'] . "'";
                                                       ?>)" 
                        ...
                        <div class="modal-content">
                            ...
                            <form action="grupo_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <input type="hidden" name="pagina" value="grupo_index.php">

                                    <label class="col-lg-2 control-label">Descripción:</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="vgru_nom" 
                                               required="" autofocus="">
                                    </div>
                                </div>
...
<?php require 'menu/js.ctp'; ?>
        ...
        <script>
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'grupo_control.php?vgru_cod=' + dat[0] + '&vgru_nom=' + dat[1]
                        + '&accion=3&pagina=grupo_index.php');
