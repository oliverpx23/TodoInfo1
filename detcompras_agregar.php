...
//                            if (!empty($ventas)) {
                                            ...
                                            <?php foreach ($compras as $compra) { ?>
                                                <tr>
                                                    <td class="text-center">
                                                        <?php echo $compra['prov_descri']; ?></td>
                                                    <td class="text-center">
                                                        <?php echo $compra['fecha']; ?></td>
                                                    <td class="text-center">
                                                        <?php echo number_format($compra['total_compra'], 0, ',', '.'); ?></td>
                                                    <td class="text-center">
                                                        <?php echo $compra['condicion_compra']; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($detcompras as $detcompra) { ?>
                                                <tr>
                                                    <td><?php echo $detcompra['id_articulo']; ?></td>
                                                    <td><?php echo $detcompra['descri_art']; ?></td>
                                                    <td><?php echo $detcompra['descri_depo']; ?></td>
                                                    <td><?php echo number_format($detcompra['det_precio_unit'], 0, ',', '.'); ?></td>
                                                    <td><?php echo $detcompra['det_cantidad']; ?></td>
                                                    
                                                    <td><?php echo number_format($detcompra['detcompra_subtotal'], 0, ',', '.'); ?></td>
                                                    <td>
                                                        <a onclick="borrar(<?php
                                                        echo "'" . $detcompra['id_articulo'] . "_" .
                                                        $_REQUEST['vcod'] . "_" .
                                                        $detcompra['cod_depo'] . "_" .
                                                        $detcompra['det_cantidad'] . "_" .
                                                        $detcompra['descri_art'] . "'"
                                                        ?>)"
                ...
                <div class="col-md-12">
                    <div class="panel-body">
                        <form action="detcompras_control.php" method="get"
                            ...
                            <input type="hidden" name="pagina" value="detcompras_agregar.php">
                            <div class="form-group">
                                <label class="col-md-4 control-label">Deposito</label>
                                <div class="col-md-4">
                                    <?php $depositos = consultas::get_datos("select * from deposito where cod_depo=2"); ?>
                                    <select name="vdep"
