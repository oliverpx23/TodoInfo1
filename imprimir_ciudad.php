...
$pdf->SetSubject('TCPDF BLASK BULLS GAMESHOP');
...
$ciudades = consultas::get_datos("select * from ciudad order by id_ciudad");

foreach ($ciudades as $ciudad) {
    $pdf->Cell(30, 5, $ciudad['id_ciudad'], 1, 0, 'R', 1);
    $pdf->Cell(0, 5, $ciudad['ciu_descri'], 1, 0, 'C', 1);
    $pdf->Ln();//salto
}
