        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Listado de Presupuestos
                    ...
                    <div class="col-lg-12">
                        <div class="panel-body">
                            ...
                            <?php $diagnostico= consultas::get_datos
                                    ("select * from v_presupuesto where cod_pres_compra=".$_REQUEST['vpres']) ?>
                            <form action="presupuesto_control.php" method="post" role="form"class="form-horizontal">
                                <input type="hidden" name="accion" value="2">
                               
                                <input type="hidden" name="vpres"
                                       value="<?php echo $diagnostico[0]['cod_pres_compra']; ?>">
                                <input type="hidden" name="pagina" value="presupuesto_index.php">
