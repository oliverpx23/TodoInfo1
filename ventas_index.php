    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Listado de Ventas
                            <a href="ventas_agregar.php" class="btn btn-primary btn-circle pull-right">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($ventas as $venta) { ?> 
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $venta['ven_total']; ?></td>
                                                        <td class="text-center"><?php echo $venta['ven_condicion']; ?></td>
                                                        ...
                                                        <td class="text-center">  
                                                           ...
                                                           <?php }else{ ?>
                                                            <a href="detventas_agregar.php?vcod=<?php echo 
                                                            $venta['id_venta']; ?>" 
            ...
            <script>
                function borrar(datos) {
                    ...
                    $('#si').attr('href', 'ventas_control.php?accion=2'+
                            '&vcod=' + dat[0] +
                            '&vusu=null' +
                            '&vcli=null' +
                            '&vfecha=1900-01-01' +
