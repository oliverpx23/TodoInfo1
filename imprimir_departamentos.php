...
$departamentos = consultas::get_datos("select * from departamentos order by id_departamento");

foreach ($departamentos as $departamento) {
    $pdf->Cell(30, 5, $departamento['id_departamento'], 1, 0, 'R', 1);
    $pdf->Cell(0, 5, $departamento['dep_descri'], 1, 0, 'C', 1);
