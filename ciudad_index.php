                                        ...
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($ciudades as $ciudad) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $ciudad['id_ciudad']; ?></td>
                                                        <td class="text-center"><?php echo $ciudad['ciu_descri']; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $ciudad['id_ciudad'] . "_" .
                                                                    $ciudad['ciu_descri'] . "'"; ?>)" 
                                                               class="btn btn-xs btn-primary" rel='tooltip' data-title="Editar" 
                                                               data-toggle="modal" data-target="#editar">
                                                                <span class="glyphicon glyphicon-pencil"></span></a>
                                                            <a onclick="borrar(<?php echo "'" . $ciudad['id_ciudad'] . "_" . 
                                                                    $ciudad['ciu_descri'] . "'"; ?>)" 
                        ...
                        <div class="modal-content">
                            ...
                            <form action="ciudad_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="vciu_nom" 
