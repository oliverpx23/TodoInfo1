...
$pdf->SetTitle('REPORTE DE DEPOSITOS');
...
$depos = consultas::get_datos("select * from deposito order by cod_depo");

foreach ($depos as $deposito) {
    $pdf->Cell(30, 5, $deposito['cod_depo'], 1, 0, 'R', 1);
    $pdf->Cell(0, 5, $deposito['descri_depo'], 1, 0, 'C', 1);
    $pdf->Ln();//salto
}
...
//SALIDA AL NAVEGADOR
$pdf->Output('reporte_depositos.pdf', 'I');
?>
