                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <?php
                            $ped_compras = consultas::get_datos
                                            ("select * from v_pedido_compras where cod_pedido_compra=" . $_REQUEST ['vcod'] . "order by cod_pedido_compra asc");
//                            if (!empty($ventas)) {
                            ?>                         
                            <!-- /.panel-heading -->
                                            ...
                                            <?php foreach ($ped_compras as $ped_compra) { ?>
                                                <tr>
                                                    <td class="text-center">
                                                        <?php echo $ped_compra['prov_descri']; ?></td>
                                                    <td class="text-center">
                                                        <?php echo $ped_compra['ped_compra_fecha']; ?></td>
                                                    <td class="text-center">
                                                        <?php echo number_format($ped_compra['total_pedido'], 0, ',', '.'); ?></td>
                                                    <td class="text-center">
                                                        <?php echo $ped_compra['ped_compra_estado']; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                        ...
                        <?php
                        $detpedcompras = consultas::get_datos
                                        ("select * from v_det_pedido_compras where cod_pedido_compra=" . $_REQUEST['vcod'] . "order by id_articulo asc");
                        ?>
                        <!-- <div class="col-md-12">-->
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                            ...
                            <?php if (!empty($detpedcompras)) { ?>
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($detpedcompras as $detpedcompra) { ?>
                                                <tr>
                                                    <td><?php echo $detpedcompra['id_articulo']; ?></td>
                                                    <td><?php echo $detpedcompra['descri_art']; ?></td>
                                                    <td><?php echo $detpedcompra['descri_depo']; ?></td>
                                                    <td><?php echo number_format($detpedcompra['det_precio_unitario'], 0, ',', '.'); ?></td>
                                                    <td><?php echo $detpedcompra['cantidad']; ?></td>
                                                    
                                                    <td><?php echo number_format($detpedcompra['pedido_subtotal'], 0, ',', '.'); ?></td>
                                                    <td>
                                                        <a onclick="borrar(<?php
                                                        echo "'" . $detpedcompra['id_articulo'] . "_" .
                                                        $_REQUEST['vcod'] . "_" .
                                                        $detpedcompra['cod_depo'] . "_" .
                                                        $detpedcompra['cantidad'] . "_" .
                                                        $detpedcompra['descri_art'] . "'"
                                                        ?>)"
                ...
                <div class="col-md-12">
                    <div class="panel-body">
                        <form action="det_pedido_compras_control.php" method="get"
                            ...
                            <input type="hidden" name="pagina" value="det_pedido_compras.php">
            ...
            <script>
                function borrar (datos) {
                    ...
                    $('#si').attr('href',
                    'det_pedido_compras_control.php?vcod=' + dat[1] +
                            '&vdep=' + dat[2] +
                            '&vcant=' + dat[3] +
                            '&vsubtotal=0' +
                            '&varti=' + dat[0] +
