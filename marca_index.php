                                        ...
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($marcas as $marca) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $marca['cod_marca']; ?></td>
                                                        <td class="text-center"><?php echo $marca['descri_marca']; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $marca['cod_marca'] . "_" .
                                            $marca['descri_marca'] . "'";
                                                    ?>)" 
                                                               class="btn btn-xs btn-primary" rel='tooltip' data-title="Editar" 
                                                               data-toggle="modal" data-target="#editar">
                                                                <span class="glyphicon glyphicon-pencil"></span></a>
                                                            <a onclick="borrar(<?php echo "'" . $marca['cod_marca'] . "_" .
                                                       $marca['descri_marca'] . "'";
                                                       ?>)" 
                        ...
                        <div class="modal-content">
                            ...
                            <form action="marca_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="vmar_nom" 
                                               required="" autofocus="">
                                    </div>
                                </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" 
                                    data-dismiss="modal" arial-label="Close">x</button>
                            <h4 class="modal-title"><strong>Editar Marca</strong></h4>
                        </div>
                        <form action="marca_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                            <div class="panel-body">
...
<?php require 'menu/js.ctp'; ?>
        ...
        <script>
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'marca_control.php?vmar_cod=' + dat[0] + '&vmar_nom=' + dat[1]
                        + '&accion=3&pagina=marca_index.php');
