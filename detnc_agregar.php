        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Datos de Notas Cred 
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            $ventas = consultas::get_datos
                                            ("select * from v_notacreds where id_notacred=" . $_REQUEST ['vcod'] . "order by id_notacred asc");
//                            if (!empty($ventas)) {
                            ?>                         
                            <!-- /.panel-heading -->
                                    ...
                                    <table width="100%"
                                        ...
                                        <thead>
                                            <tr class="success">
                                                ...
                                                <th class="text-center">COND NC</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($ventas as $venta) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php echo number_format($venta['nc_total'], 0, ',', '.'); ?></td>
                                                    <td class="text-center">
                                                        <?php echo $venta['nc_condicion']; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                        ...
                        <?php
                        $detventas = consultas::get_datos
                                        ("select * from v_detnotacreds where id_notacred=" . $_REQUEST['vcod'] . "order by id_articulo asc");
                        ?>
                                        ...
                                        <tbody>
                                            <?php foreach ($detventas as $detventa) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $detventa['descri_art']; ?></td>
                                                    <td><?php echo $detventa['descri_depo']; ?></td>
                                                    <td><?php echo number_format($detventa['det_precio_unit'], 0, ',', '.'); ?></td>
                                                    <td><?php echo $detventa['det_cantidad']; ?></td>
                                ...
                                <?php } else { ?>
                                    <div class="col-md-12">
                                        <div class="alert alert-info alert-dismissable">
                                            ...
                                            <strong>No se encontraron detalles para la Nota....!</strong>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
                ...
                <div class="col-md-12">
                    <div class="panel-body">
                        <form action="detnc_control.php" method="get"
                            ...
                            <input type="hidden" name="pagina" value="detnc_agregar.php">
                            <div class="form-group">
                                <label class="col-md-4 control-label">Deposito</label>
                                <div class="col-md-4">
                                    <?php $depositos = consultas::get_datos("select * from deposito where cod_depo=1"); ?>
                                    <select name="vdep"
