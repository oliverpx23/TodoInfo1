        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Listado de Stock 
                                ...
                                <div class="panel-body">
                                    <div>
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">DEPOSTIO</th>
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($stocks as $stock) { ?> 
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $stock['stock_cantidad']; ?></td>
                                                        <td class="text-center">
                                                            <!--                                                            <a onclick="editar(<?php echo "'" . $stock['id_ciudad'] . "_" .
                                            $ciudad['ciu_descri'] . "'";
                                                    ?>)" 
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title"><strong>Registrar Stock</strong></h4>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $depositos = consultas::get_datos("select * from deposito "
                                                            . " order by cod_depo");
                                            ?>                                 
                                            <select name="vdep" id="coddep" class="form-control select4">
                                                <?php
                                                if (!empty($depositos)) {
...
<?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            ?>                                 
                                            <select name="vartdescri" id="codart" class="form-control select9">
                                                <?php
                                                if (!empty($articulos)) {
...
<?php } ?>
                                    ...
                                    <div class="col-lg-3">
                                        <input id="cantstock" type="number" class="form-control" name="vcant" 
                                               required="" autofocus="">
                                    </div>
                                </div>
                                    <ln></ln>
...
//            }
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'stock_control.php?vdep=' + dat[0] + 
                        '&vartdescri=' + dat[1] +
                        '&vcant=' + dat[2] +
                        '&accion=2&pagina=stock_index.php');
                $('#confirmacion').html('<span class="glyphicon glyphicon-warning-sign"></span>\n\
            Desea Borrar el <i><strong>' + dat[1] + '</strong></i>?');
            }
        </script>
