    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Registar Diagnóstico 
                ...
                <div class="row">
                    <div class="col-lg-12">                                         
                        ...
                        <?php $fecha=consultas::get_datos("select * from v_fecha1"); ?>
                            <form action="diagnostico_control.php" method="post" 
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="vrecep" class="form-control select2">
                                            ...
                                            if (!empty($recepciones)) {
                                                ...
                                                ?>
                                                <option value="0">Debe insertar una recepción</option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="vtecnico" class="form-control select2">
                                            ...
                                            if (!empty($tecnicos)) {
                                                ...
                                                ?>
                                                <option value="0">Debe insertar un técnico</option>
                                            <?php } ?>
                                        </select>
                                    </div>
