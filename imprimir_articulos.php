...
$articulos = consultas::get_datos("select * from v_articulos order by id_articulo");

foreach ($articulos as $articulo) {
    $pdf->Cell(30, 5, $articulo['id_articulo'], 1, 0, 'R', 1);
    $pdf->Cell(30, 5, $articulo['descri_marca'], 1, 0, 'R', 1);
    $pdf->Cell(60, 5, $articulo['descri_art'], 1, 0, 'C', 1);
    $pdf->Cell(30, 5, $articulo['precio_art'], 1, 0, 'R', 1);
