                    ...
                    <div class="col-lg-12">
                        <div class="panel-body">
                            <?php $cliente= consultas::get_datos
                                    ("select * from cliente where id_cliente=".$_REQUEST['vcod']) ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <input type="text" required="" placeholder="Ingrese nombre"  
                                          pattern="[A-Za-z ]+" title="Ingresa sólo letras. Tamaño mínimo: 5. Tamaño máximo: 40" 
                                           class="form-control" name="vnombre"
                                   value="<?php echo $cliente[0]['cli_nombre'];?>"><!--solo letras con espacios-->
                                    </div>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        $paises = consultas::get_datos("select * from pais "
                                                        . " order by cod_pais=".$cliente[0]['cod_pais']."desc");
                                        ?>                                 
