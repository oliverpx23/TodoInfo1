...
<!--                                                    <a href="#" class="list-group-item">Cursos</a>                                                                          -->
        ...
        <script>
            function obtener_ciudad() {
                $.ajax({
                    type: "POST",
                    url: "/bd_distribuidora/inf_prov_ciu.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/bd_distribuidora/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
             ...
             function obtener_departamento() {
                $.ajax({
                    type: "POST",
                    url: "/bd_distribuidora/inf_prov_dep.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/bd_distribuidora/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
