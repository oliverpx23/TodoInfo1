        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Listado de las Cuentas a Cobrar
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <?php
                            $ctas_cobrar = consultas::get_datos("select * from v_ctas 
                                         order by cta_id asc ");
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($ctas_cobrar as $cta_cobrar) { ?> 
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $cta_cobrar['id_venta']; ?></td>
                                                        <td class="text-center"><?php echo $cta_cobrar['ven_fecha']; ?></td>
                                                        <td class="text-center"><?php echo $cta_cobrar['ven_condicion']; ?></td>
                                                        <td class="text-center"><?php echo $cta_cobrar['cta_vto']; ?></td>
                                                        <td class="text-center"><?php echo $cta_cobrar['cta_importe']; ?></td>
