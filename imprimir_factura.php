...
$sqlventas = "select *,(select numero_letras(ven_total)) as total_letra "
      . " from v_ventas where id_venta = " . $_REQUEST ['vcod'] . " order by 1";
...
$pdf->Cell(100, 1, 'NRO.: ' . $rsventas[0]['factura'], 0, 1, 'C');
...
$pdf->Cell(/*1*/90, /*2*/1, /*3*/$rsventas[0]['fecdate'], /*4*/0, /*5*/1, /*6*/'L', /*7*/null, /*8*/null, /*9*/1, /*10*/null, /*11*/null, /*12*/null);
$pdf->Ln(3);
//nombre cliente
$pdf->SetFont('Times', 'B', 10);
...
$pdf->SetFont('Times', '', 10);
$pdf->Cell(90, 1, $rsventas[0]['cli_ci'], 0, 1, 'L');
...
$pdf->SetFont('Times', '', 10);
$pdf->Text(165, 243, 'Gs. '.number_format(($rsventas[0]['ven_total']),0,',','.'));
$pdf->SetFont('Times', 'B', 10);
$pdf->Text(18, 251, 'TOTAL EN LETRAS');
$pdf->SetFont('Times', '', 10);
$pdf->Text(55, 251, 'Son Gs. '.ucfirst(strtolower ($rsventas[0]['total_letra'])));
